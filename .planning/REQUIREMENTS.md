...
- [ ] **CMP-01**: Tela lista, item a item, os impostos esperado (XML) vs. calculado (script): base ICMS, vlr ICMS, base ST, ICMS ST, base PIS/COFINS, vlr PIS/COFINS, DIFAL, FCP, entre outros
- [ ] **CMP-02**: Divergências entre esperado e calculado são destacadas visualmente (ex.: cor/ícone) com a diferença numérica
