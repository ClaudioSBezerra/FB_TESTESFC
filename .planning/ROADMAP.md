...
- [x] **Phase 3: Visual Comparison Screen** - Tela de comparação visual item a item (esperado vs. calculado) com divergências destacadas (completed 2026-07-02)
...
- [x] 03-03-PLAN.md — Checkpoint de verificação humana de fim de fase (CMP-01..04 contra dados reais)
...
- [ ] 03.1-01-PLAN.md — Modelo de navegação (4 módulos em navigation.ts) + novo componente ModuleTabs com filtro adminOnly (dados do BLOCKER-1)
- [ ] 03.1-02-PLAN.md — Ligar 4 ícones clicáveis no AppRail + renderizar ModuleTabs no layout + corrigir redirects de login/raiz (fiação do BLOCKER-1 + BLOCKER-2)
